...
// Funcionalidad de senales en zoho CRM
const namespace = "zohodesk_newticketalert";
const subject = "New Ticket created #" + ticket_id;
const message = "New Ticket with " + ticket_subject + " created in Zoho Desk" + " from " + email;

const signalMap = new Map();
signalMap.set("signal_namespace", namespace);
signalMap.set("email", email);
signalMap.set("subject", subject);
signalMap.set("message", message);

const result = zoho.crm.raiseSignal(signalMap);